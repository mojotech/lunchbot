defmodule LunchbotWeb.Router do
  use LunchbotWeb, :router

  import LunchbotWeb.UserAuth
  ...
  scope "/admin", LunchbotWeb.Admin, as: :admin do
    ...
    resources "/item_option_headings", ItemOptionHeadingsController
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: LunchbotWeb.Telemetry
    end
  end
